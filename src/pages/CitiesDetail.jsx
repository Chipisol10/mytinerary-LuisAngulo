...
const CitiesDetails = () => {
  ...
  return (
    <div 
      ...
      <p className="text-xl text-white drop-shadow-md mb-6">Sorry for the inconvenience but this page is currently being rebuilt to provide a pleasant experience </p>
      <button 
        onClick={() => navigate(-1)} 
